# Portfolio Control: #13 mini-aws-emulator

## Identity

- **Program:** <program>
- **Status:** scaffold
- **Proves:** paridade local AWS para S3, SQS e DynamoDB com adaptadores desacoplados
- **Primary benchmark:** `conformance_rate_percent`
